...
function enqueue_alert_block_admin_scripts() {
    wp_enqueue_script('custom-alert-block-editor');
}
add_action('enqueue_block_editor_assets', 'enqueue_alert_block_admin_scripts');
